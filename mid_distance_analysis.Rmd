...
```{r 800m-models}
# TODO: Functionize all of this so I can rerun the analyses specifically on different target race time ranges (e.g. find the optimal values for 2:35-2:45). Alternatively, could just predict the values for those ranges.
